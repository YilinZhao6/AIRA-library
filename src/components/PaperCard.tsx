...
const PaperCard: React.FC<PaperCardProps> = ({ paper, featured = false }) => {
  return (
    <motion.div 
      className={`bg-surface-light dark:bg-surface-dark rounded-xl p-8 ${featured ? 'shadow-lg' : 'shadow-sm'} hover:shadow-md transition-shadow border border-border-light dark:border-border-dark`}
