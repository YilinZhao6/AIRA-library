...
const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-white" style={{ fontFamily: 'Roboto, system-ui, sans-serif' }}>
      <header className="py-6 px-8 border-b border-gray-200 bg-white sticky top-0 z-50">
        <nav className="max-w-7xl mx-auto flex justify-between items-center">
          <Link to="/" className="flex flex-col">
            <span className="text-2xl font-medium tracking-tight">AIRA</span>
            <span className="text-sm text-gray-500 -mt-1">Artificial Intelligence Research Assistant</span>
          </Link>
          <div className="space-x-8">
            ...
            <Link 
              to="/archive" 
              className={`${isActive('/archive') ? 'text-blue-600' : 'text-gray-600'} hover:text-blue-600 transition-colors`}
            >
              Archive
            </Link>
            <Link 
              to="/request" 
              className={`${isActive('/request') ? 'text-blue-600' : 'text-gray-600'} hover:text-blue-600 transition-colors`}
            >
              Request Paper
            </Link>
            <Link 
      ...
      <footer className="bg-gray-50 border-t border-gray-200 mt-16">
        <div className="max-w-7xl mx-auto px-8 py-12">
          <div className="grid grid-cols-4 gap-8">
            <div>
              <h3 className="text-lg font-medium mb-4">AIRA</h3>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link to="/archive" className="text-gray-600 hover:text-blue-600 text-sm">Paper Archive</Link></li>
                <li><Link to="/request" className="text-gray-600 hover:text-blue-600 text-sm">Request Paper</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-600 hover:text-blue-600 text-sm">Research Blog</a></li>
              </ul>
            </div>
            <div>
