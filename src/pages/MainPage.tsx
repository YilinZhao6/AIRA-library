...
const MainPage = () => {
  ...
  return (
    <div className="h-screen flex overflow-hidden bg-background-light dark:bg-background-dark">
      ...
      <div className="w-1/4 h-full p-8 bg-gray-50 dark:bg-surface-dark flex flex-col justify-center">
        <div className="space-y-6 -mt-[20vh]">
      ...
      {/* Video Section */}
      <div className="w-1/2 h-full p-8 bg-white dark:bg-surface-dark-focus">
        <div className="h-full flex flex-col">
          <div className="flex-1 flex flex-col justify-center items-center">
            ...
            <h2 className="text-2xl font-medium mt-6 mb-4 text-gray-900 dark:text-gray-100">
              See AIRA in Action
            </h2>
          </div>
        </div>
      ...
      <div className="w-1/4 h-full p-8 bg-gray-50 dark:bg-surface-dark">
        <div className="h-full flex flex-col">
